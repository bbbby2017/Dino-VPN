...
> DinoVPN 基于 Clash Verge Rev 二次开发，本版本已合并上游官方 v2.5.2 的全部修复与改进（详见下方 v2.5.2 记录）。

### ✨ DinoVPN 变更

- 合并上游 Clash Verge Rev v2.5.2 的全部修复、新增功能与优化
- 全新统一首页「快捷控制」卡片：代理开关、增强模式、代理模式切换、节点选择与延迟检测、订阅摘要一体化
- 关闭自动更新：移除 updater 插件与相关配置，不再向用户推送更新
- 锁定 mihomo 服务组件 clash-verge-service-ipc 至 v2.3.3，避免服务协议版本不匹配
- 保留 DinoVPN 定制能力：渠道识别、流媒体解锁检测、多级代理链
- 全面清理上游品牌指向，界面、文档与 CI 统一为 DinoVPN

---

## v2.5.2

> 以下为合并自上游 Clash Verge Rev v2.5.2 的更新内容。
